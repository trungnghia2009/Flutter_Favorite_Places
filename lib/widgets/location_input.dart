...
import 'package:a6_favorite_places/screens/map.dart';
...
class _LocationInputState extends State<LocationInput> {
  final apiKey = 'AIzaSyAAJ1UId-E2VZOZObb5YpMlKTlwMcl4TKU';
  ...
  void _selectOnMap() async {
    ...
    debugPrint("Location getting: ${pickedLocation.latitude}, ${pickedLocation.longitude}");
